...
Once you have installed the package, you donâ€™t need to load it with `library()`, the addins are installed on your machine as part of the package install process.
