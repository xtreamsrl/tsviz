# Getting help with tsviz

Thanks for using tsviz. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/tsviz/issues) to make sure the 
